...
const main = async () => {
  ...
  app.use(cors())
  // Đăng ký các route
  app.use(APP_ROUTES.USER, userRouter)
  app.use(APP_ROUTES.AUTH, authRouter)
  app.use(APP_ROUTES.OAUTH, oauth2Router)
  app.use(APP_ROUTES.PROTECTED, protectedRouter)
  app.use(APP_ROUTES.CHAT, chatRouter)
  app.use(APP_ROUTES.MESSAGE, messageRouter)
  app.use(APP_ROUTES.MEDIA, mediaRouter)
